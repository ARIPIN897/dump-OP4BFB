...
function smapsforhealth(){
  ...
  chown system:system ${opmlogpath}smaps.txt
}
...
#Kang.Zou@PSW.AD.Performance.Storage.1721598, 2019/10/14, Add for customize version to control sdcard with new methods
